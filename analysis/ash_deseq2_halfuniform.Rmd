---
title: "Estimate the proportion of true null (half-uniform)"
...
#deseq2.fit <- ashr::ash(betahat, sebetahat, mixcompdist = "halfuniform", outputlevel=2)
#saveRDS(deseq2.fit, file="../output/deseq2.fit.hu.RDS")
deseq2.fit <-readRDS("../output/deseq2.fit.hu.RDS") # the above step may take long without REBayes
```
