...
# deseq2.fit <- ashr::ash(betahat, sebetahat, mixcompdist = "normal", outputlevel=2, control= list(maxiter=20000))
deseq2.fit <-readRDS("deseq2.fit.RDS") # the above step may take long without REBayes
```
...
plot(t,prop, main= "proportion of regions with |log2Fold change| < t", xlab= "log2Fold change", ylab="proportion", yaxt="n", pch = 16, col="salmon")
